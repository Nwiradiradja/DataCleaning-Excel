...
* Up next we want to handle any duplicates. To do so we highlight the range of cells and go to the data tab where we see the remove duplicates icon as shown by [ ]. Once we hit 'Ok' all duplicates are removed. As seen by imnage
